...
Ti.include("/vendor/jasmine-titanium/lib/jasmine-titanium-window-reporter.js");
...
jasmine.getEnv().addReporter(new jasmine.TitaniumWindowReporter(JasmineTitaniumApp.verbose));
